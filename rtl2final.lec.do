...
# Generated on: Fri Feb 15 07:55:02 IST 2019 (Fri Feb 15 02:25:02 GMT 2019)
...
set_log_file logs_250MHz_lvt_65_35_0/rtl2final.lec.log -replace

usage -auto -elapse

# Comparing intermediate 'fv_map' netlist vs. revised netlist.

set_verification_information fv_map_a23_decode_mv_db

read_implementation_information fv/a23_decode -golden fv_map -revised a23_decode_mv
...
add_search_path /home/vv2trainee16/PNR_INNOVUS/amber_lvt_250/lvt_lib -library -both
read_library -liberty -both   /home/vv2trainee16/PNR_INNOVUS/amber_lvt_250/lvt_lib/slow.lib /home/vv2trainee16/PNR_INNOVUS/amber_lvt_250/lvt_lib/slow_vdd1v0_basicCells_lvt.lib

read_design -verilog95   -golden -lastmod -noelab fv/a23_decode/fv_map.v.gz
elaborate_design -golden -root {a23_decode}

read_design -verilog95   -revised -lastmod -noelab outputs_250MHz_lvt_65_35_0/a23_decode_m.v
elaborate_design -revised -root {a23_decode}

#add_name_alias fv/a23_decode/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/a23_decode/a23_decode_mv.singlebit.original_name.alias.json.gz -revised
...
read_implementation_information fv/a23_decode -revised fv_map
...
add_search_path /home/vv2trainee16/PNR_INNOVUS/amber_lvt_250/rtl -design -golden
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k /home/vv2trainee16/PNR_INNOVUS/amber_lvt_250/rtl/a23_decode.v
elaborate_design -golden -root {a23_decode} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/a23_decode/fv_map.v.gz
elaborate_design -revised -root {a23_decode}
...
#add_name_alias fv/a23_decode/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff -both
